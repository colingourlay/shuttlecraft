...
import { getAuthorizedAccessTokens } from './tokens.js';
...
export const getApplicationForAuthorizedAccessToken = authorizedAccessToken => {
  const applicationId = getAuthorizedAccessTokens()[authorizedAccessToken];
