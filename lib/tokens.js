...
const addAuthorizedAccessToken = accessToken => {
  const authorizedAccessTokens = getAuthorizedAccessTokens();

  setAuthorizedAccessTokens([...authorizedAccessTokens, accessToken]);
};

export const isAccessTokenAuthorized = accessToken => {
  return getAuthorizedAccessTokens().includes(accessToken);
};
...
export const useCode = token => {
  ...
  addAuthorizedAccessToken(token.accessToken);
